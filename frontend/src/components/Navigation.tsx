...
import { faRightToBracket, faRightFromBracket ,faFileCirclePlus, faUser, faGear, faChampagneGlasses} from "@fortawesome/free-solid-svg-icons"
        ...
        <Navbar.Collapse id="navbarScroll">
          <Nav className="me-auto my-2 my-lg-0" style={{ maxHeight: '200px' }} navbarScroll>
            {!auth ? (
              ...
              <>
                <NavLink className="nav-link" to='/festas'><FontAwesomeIcon icon={faChampagneGlasses} /> Minhas Festas</NavLink>
                <NavLink className="nav-link" to='/servicos'><FontAwesomeIcon icon={faGear} /> Serviços</NavLink>
