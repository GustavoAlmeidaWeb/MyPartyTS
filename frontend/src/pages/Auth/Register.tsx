  ...
  return (
    <Col md={{ span: 10, offset: 1 }} lg={{ span: 10, offset: 1 }} xl={{ span: 8, offset: 2 }}>
      ...
      <Form className="mb-3" onSubmit={handleSubmit}>
        ...
        <FloatingLabel controlId="floatingPassword" label="Confirmação de Senha" className="mb-3 text-dark" >
          <Form.Control type="password" placeholder="Confirmação de Senha" onChange={(e) => setConfirmPassword(e.target.value)} value={confirmpassword || ''} />
          <button type="button" className="position-absolute btn btn-show-password text-primary"><FontAwesomeIcon icon={faEye} /></button>
        </FloatingLabel>
        ...
        <p className="text-center mt-2">Já tem seu cadastro ? <Link className="text-decoration-none" to='/login'>Faça o login</Link></p>
      </Form>
